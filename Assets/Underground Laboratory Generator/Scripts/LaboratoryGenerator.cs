...
{
    public GameObject labRoomsParent;
    ...
    IEnumerator StartGeneration()
    {
        ...
        StartRoom.gameObject.name += "Starting Room";
        StartRoom.transform.SetParent(labRoomsParent.transform);
        ...
        while (limit > 0 && roomsLeft > 0)
        {
            ...
            selectedPrefab.transform.SetParent(labRoomsParent.transform);
            ...
            if (lim > 0)
            {
                ...
                GameObject doorSelected = Instantiate(DoorPrefabs[Random.Range(0, DoorPrefabs.Length)], createdExit.transform.position,
                    createdExit.transform.rotation);

                doorSelected.transform.SetParent(labRoomsParent.transform);
        ...
        for (int i = 0; i < CreatedExits.Count; i++)
        {
            ...
            door.transform.SetParent(labRoomsParent.transform);
